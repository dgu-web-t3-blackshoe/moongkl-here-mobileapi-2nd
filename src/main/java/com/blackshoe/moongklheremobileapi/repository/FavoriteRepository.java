...
public interface FavoriteRepository extends JpaRepository<Favorite, UUID> {
    ...
    @Query("SELECT new com.blackshoe.moongklheremobileapi.dto.PostDto$PostListReadResponse(" +
            ...
            "AND f.post.skinLocation.country = :#{#postAddressFilter.country} " +
            "AND f.post.skinLocation.state = :#{#postAddressFilter.state} ")
    Page<PostDto.PostListReadResponse> findAllUserFavoritePostByState(User user, PostAddressFilter postAddressFilter, Pageable pageable);
    ...
    @Query("SELECT new com.blackshoe.moongklheremobileapi.dto.PostDto$PostListReadResponse(" +
            ...
            "WHERE f.user = :user " +
            "AND f.post.skinLocation.country = :#{#postAddressFilter.country} ")
    Page<PostDto.PostListReadResponse> findAllUserFavoritePostByCountry(User user, PostAddressFilter postAddressFilter, Pageable pageable);
