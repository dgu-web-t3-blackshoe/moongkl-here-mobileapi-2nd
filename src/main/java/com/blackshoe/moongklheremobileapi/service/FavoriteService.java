...
public interface FavoriteService {
    ...
    Page<PostDto.PostListReadResponse> getUserStateFavoritePostList(User user, String country, String state, String sort, Integer size, Integer page);

    Page<PostDto.PostListReadResponse> getUserCountryFavoritePostList(User user, String country, String sort, Integer size, Integer page);
