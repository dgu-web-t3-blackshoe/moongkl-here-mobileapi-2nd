...
ON DUPLICATE KEY UPDATE cloudfront_url = cloudfront_url AND s3url = s3url;
...
INSERT INTO users (id, email, password, nickname, phone_number, gender, country, role, created_at,
                   favorite_count, like_count, status_message, updated_at, background_img_url_id, profile_img_url_id)
